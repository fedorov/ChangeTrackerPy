...
class ChangeTracker:
  def __init__( self, parent ):
    ...
    parent.contributor = """Andrey Fedorov, Ron Kikinis"""
    parent.helpText = """
    ...
    """;
    parent.acknowledgementText = """This work is supported by NA-MIC, NAC, NCIGT, and the Slicer Community. See <a href="http://www.slicer.org">http://slicer.org</a> for details.  Module implemented by Andrey Fedorov. This work is partially supported by NIH U01 CA151261
    """
    self.parent = parent
